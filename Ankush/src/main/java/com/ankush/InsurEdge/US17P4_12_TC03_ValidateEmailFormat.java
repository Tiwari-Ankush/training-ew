...
public class US17P4_12_TC03_ValidateEmailFormat {
    ...
    public static boolean validation_tc03(WebDriver driver) {
        WebDriverWait wait = getWait(driver);
        try {
            ...
            for (int i = 0; i < limit; i++) {
                ...
                if (email.isEmpty() || email.contains(" ") || !email.matches(emailRegex)) {
                    System.out.println("fail: row " + (i + 1) + " email " + email);
                    return false;
                } else {
                    System.out.println("pass: row " + (i + 1) + " email "+ email);
                }
            }
            ...
            System.out.println("validation_tc03 failed: " + e.getMessage());
            return false;
        }
    }
    ...
    public static void main(String[] args){
        ...
        try {
            ...
            if (validation_tc03(driver)) {
                System.out.println("US17P4_12_TC03: PASSED");
            } else {
                System.out.println("US17P4_12_TC03: FAILED");
            }
        } catch (Exception e) {
