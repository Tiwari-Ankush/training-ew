...
public class US17P4_12_TC08_ValidatePremiumFormat {
    ...
    public static boolean validation_tc08(WebDriver driver) {
        WebDriverWait wait = getWait(driver);
        ...
        try {
            ...
            for (int i = 0; i < limit; i++) {
                ...
                // Premium is column index 7 (0-based)
                String premium = cells.get(7).getText().trim();

                // Must be digits with two decimals (e.g., 12345.67)
                if (!premium.matches("\\d+\\.\\d{2}")) {
                    System.out.println("fail: row " + (i + 1) + " premium " + premium);
                    return false;
                } else {
                    System.out.println("pass: row " + (i + 1) + " premium " + premium);
                }
            }
            return true;
        } catch (Exception e) {
            System.out.println("validation_tc08 failed: " + e.getMessage());
            return false;
        }
    }
    ...
    public static void main(String[] args){
        ...
        try {
            ...
            if (validation_tc08(driver)) {
                System.out.println("US17P4_12_TC08: PASSED");
            } else {
                System.out.println("US17P4_12_TC08: FAILED");
            }
        } catch (Exception e) {
