...
public class US17P4_12_TC11_ValidateActionsButtonsDisplay {
    ...
    public static boolean validation_tc11(WebDriver driver) {
        WebDriverWait wait = getWait(driver);
        try {
            ...
            for (int i = 0; i < limit; i++) {
                ...
                WebElement actionsCell = cells.get(10);
                ...
                boolean approveOk = (!approveBtns.isEmpty()) && approveBtns.get(0).isDisplayed();
                boolean rejectOk  = (!rejectBtns.isEmpty())  && rejectBtns.get(0).isDisplayed();
                
                if (!approveOk || !rejectOk) {
                    System.out.println("fail: row " + (i + 1) + " approve/reject missing");
                    return false;
                } else {
                    System.out.println("pass: row " + (i + 1) + " approve & reject visible");
                }
            }
            return true;
        } catch (Exception e) {
            System.out.println("validation_tc11 failed: " + e.getMessage());
            return false;
        }
    ...
    public static void main(String[] args){
        ...
        try {
            ...
            if (validation_tc11(driver)) {
                System.out.println("US17P4_12_TC11: PASSED");
            } else {
                System.out.println("US17P4_12_TC11: FAILED");
            }
        } catch (Exception e) {
